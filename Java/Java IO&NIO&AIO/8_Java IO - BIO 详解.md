...
![java-io-bio-1](Images/java-io-bio-1.png)
...
![java-io-bio-2](Images/java-io-bio-2.png)
...
![java-io-bio-3](Images/java-io-bio-3.png)
...
![java-io-bio-4](Images/java-io-bio-4.png)



- 注意，是询问操作系统。也就是说socket套接字的IO模式支持是基于操作系统的，那么自然同步IO/异步IO的支持就是需要操作系统级别的了。如下图:

![java-io-bio-5](Images/java-io-bio-5.png)

![java-io-bio-6](Images/java-io-bio-6.png)
