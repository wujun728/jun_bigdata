...
![java-jvm-agent-1](Images/java-jvm-agent-1.png)
...
![java-jvm-agent-2](Images/java-jvm-agent-2.png)
...
VM_RedefineClasses实现比较复杂的，详细实现可以参考 [RedefineClasses  (opens new window)](https://github.com/pandening/openjdk/blob/0301fc792ffd3c7b506ef78887af250e0e3ae09e/src/hotspot/share/prims/jvmtiEnv.cpp#L456)的实现。
...
![java-jvm-agent-3](Images/java-jvm-agent-3.png)
...
![java-jvm-agent-4](Images/java-jvm-agent-4.png)
...
![java-jvm-agent-5](Images/java-jvm-agent-5.png)
...
![java-jvm-agent-6](Images/java-jvm-agent-6.png)
