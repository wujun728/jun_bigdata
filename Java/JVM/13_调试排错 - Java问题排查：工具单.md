...
更多请参考: [jvm 性能调优工具之 jstack  (opens new window)](https://www.jianshu.com/p/025cb069cb69)
...
更多请参考：[jvm 性能调优工具之 jmap  (opens new window)](https://www.jianshu.com/p/a4ad53179df3) 和 [jmap - Memory Map  (opens new window)](https://docs.oracle.com/javase/1.5.0/docs/tooldocs/share/jmap.html)
...
具体参数可见oracle官方说明[jdb - The Java Debugger  (opens new window)](http://docs.oracle.com/javase/7/docs/technotes/tools/windows/jdb.html)
